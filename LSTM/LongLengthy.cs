...
namespace Learningtotranslatesequences
{
    ...
    public class LongLengthy 
    {
        ...
        public LongLengthy(int hdim, int dim)
        {
        ...
        public  WeightMatrix SynonymPace(WeightMatrix input, ComputeGraph innerGraph)
        {
        ...
        public virtual List<WeightMatrix> Retrieve()
        {
