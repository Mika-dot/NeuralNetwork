...
{
    public class Contextdependentsequencetosequence
    {
        ...
        public Contextdependentsequencetosequence(int inputSize, int hiddenSize, int depth, List<List<string>> input, List<List<string>> output, bool useDropout)
        {
            ...
            decoder = new ContextDecrypt(hidden_size, word_size, depth);
